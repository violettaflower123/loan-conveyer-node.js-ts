import { calculateOffer } from '../controllers/calculation.controller';
import { ScoringDataDTO, EmploymentDTO, Gender, EmploymentStatus, Position, MaritalStatus } from '../dtos';
...
describe('calculateOffer', () => {
  it('should calculate offer successfully', async () => {
    ...
    await calculateOffer(mockReq, mockRes);
